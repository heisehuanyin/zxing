...
final class CameraConfigurationManager {
  ...
  void initFromCameraParameters(OpenCamera camera) {
    ...
    if (camera.getFacing() == CameraFacing.FRONT) {
      overrideRotationString = prefs.getString(PreferencesKey.KEY_FORCE_CAMERA_ORIENTATION_FRONT, null);
    } else {
      overrideRotationString = prefs.getString(PreferencesKey.KEY_FORCE_CAMERA_ORIENTATION, null);
    }
  ...
  void setDesiredCameraParameters(OpenCamera camera, boolean safeMode) {
    ...
    CameraConfigurationUtils.setFocus(
        parameters,
        prefs.getBoolean(PreferencesKey.KEY_AUTO_FOCUS, true),
        prefs.getBoolean(PreferencesKey.KEY_DISABLE_CONTINUOUS_FOCUS, false),
        safeMode);
